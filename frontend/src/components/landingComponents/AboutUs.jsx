...
function AnimatedCounter({ target, suffix = "" }) {
  ...
  return (
    <span
      ref={ref}
      className="text-4xl md:text-5xl font-bold font-host_grotesk text-platinum-500">
...
const MILESTONES = [
  {
    year: "2024",
    title: "The Birth of navéro",
    text: "navéro was born as an idea for an university entrepreneurship project.",
    icon: Lightbulb,
  },
  {
    year: "2025-26",
    title: "Prototype",
    text: "Despite having a business education background, the founder self-taught himself full stack development and started creating the first prototype for navero by mid 2025, and completed in early 2026.",
    icon: TrendingUp,
  },
  {
    year: "2026-Now",
    title: "Funding",
    text: "Still searching for funds.",
    icon: PiggyBankIcon,
  },
];
...
const TEAM = [
  {
    ...
    role: "Founder, CEO, and Everything Else",
    initials: "NP",
    bio: "As a part of a university project, Nirmaldas observed how companies manage multi-million-dollar international transactions using spreadsheets, PDFs, email chains, and manual paperworks. This insight drove the creation of Navero — a platform designed to replace fragmented tools with unified digital infrastructure for global trade.",
  },
];
...
export default function AboutUs() {
  ...
  return (
    <section className="min-h-screen pt-24 pb-20">
      {/* Fixed Background - tracks mouse movements */}
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 ">
          <Motion.div
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-host_grotesk text-platinum-500 leading-tight">
              Building the <span className="">Operating System</span>
              <br />
              <span className="text-punch_red-500">for Global Trade</span>
            </h1>
            <p className="mt-6 text-lg text-platinum-400 max-w-3xl mx-auto leading-relaxed font-neue_montreal">
              ...
              activities in the global economy. A single cross-border shipment
              can involve 20–30 organizations, 40+ documents, and 200+ data
              fields across multiple regulatory agencies and logistics
              providers. Despite facilitating over $25 trillion in annual
              commerce, the infrastructure remains fragmented and heavily
              manual.
            </p>
            <p className="mt-4 text-lg text-platinum-300 max-w-3xl mx-auto leading-relaxed font-neue_montreal">
              Navero was created to change this — providing a centralized
              digital platform that integrates documentation, compliance,
              logistics coordination, financial settlement, and trade analytics
          ...
          <Motion.div
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="p-8 rounded-2xl bg-linear-to-br from-space_indigo-300/80 to-space_indigo-400/40 border border-space_indigo-500">
                <p className="text-platinum-500 leading-relaxed text-lg font-neue_montreal">
                  The founding thesis behind Navero is that global trade
                  infrastructure has not evolved at the same pace as other
                  critical economic systems. While industries such as finance
                  and e-commerce have undergone massive digital transformation,
                  the operational backbone of international trade still relies
                  heavily on manual processes and fragmented systems.
                </p>
                <p className="mt-4 text-platinum-500 leading-relaxed text-lg font-neue_montreal">
                  ...
                  disconnected stakeholders were slowing down global trade
                  flows.
                </p>
                <p className="mt-4 text-punch_red-600 leading-relaxed text-lg font-neue_montreal">
                  ...
                  international trade systems should function in the digital
                  era.
                </p>
              </div>
            </div>
              ...
              {VALUES.map((v, i) => (
                <Motion.div
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full px-3 bg-space_indigo-400/50 flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <Motion.div
            ...
            <AnimBtn ctaText={"GET STARTED"} to={"/pricing"} bgColor={"bg-punch_red-500"} textColor={"text-platinum-600"} hoverColor={"bg-punch_red-400"} showArrow={true}/>
          </Motion.div>
        </div>
      </div>
    </section>
